<script>
   $(document).ready(function() {
     $head = $('#header');
     $head.prepend('<img src=\"figure/1x/logo.png\" style=\"float: left;width: 75px;\"/>')
   });
</script>

---
title: "CoV-Seq: Coronavirus Sequence Database"
output:
...
DT::datatable(annotation[,list(ALLELE, EFFECT, IMPACT, GENE,HGVS_C,HGVS_P, CDS_POS, AA_POS, DISTANCE)], filter = 'bottom', caption = 'Table 3: Genomic Variant Annotation from SnpEff.', colnames = c("Alt", "Effect", "Impact", "Gene","HGVS.C", "HGVS.P", "CDS position", "AA position", "Distance"))
```
