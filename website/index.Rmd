...
<div class="col-sm-6">
<a href="http://flask-320.eba-xs7nerpb.us-west-2.elasticbeanstalk.com/browse"><button type="button" class="btn btn-primary btn-lg btn-block">Data and Analysis</button></a>
</div>

<div class="col-sm-6">
<a href="http://flask-320.eba-xs7nerpb.us-west-2.elasticbeanstalk.com/browse"><button type="button" class="btn btn-warning btn-lg btn-block">Interactive Visualization</button></a>
</div>
...
<div class="col-sm-6">
<a href="https://github.com/boxiangliu/covseq"><button type="button" class="btn btn-success btn-lg btn-block">Source Code</button></a>
</div>

<div class="col-sm-6">
<a href="http://flask-320.eba-xs7nerpb.us-west-2.elasticbeanstalk.com/faq"><button type="button" class="btn btn-danger btn-lg btn-block">FAQ</button></a>
</div>
