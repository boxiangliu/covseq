...
<div class="col-sm-6">
<a href="http://covseq.baidu.com/browse"><button type="button" class="btn btn-primary btn-lg btn-block">Data and Analysis</button></a>
</div>

<div class="col-sm-6">
<a href="http://covseq.baidu.com/upload"><button type="button" class="btn btn-warning btn-lg btn-block">Interactive Visualization</button></a>
</div>
...
<div class="col-sm-6">
<a href="http://covseq.baidu.com/faq"><button type="button" class="btn btn-danger btn-lg btn-block">FAQ</button></a>
</div>
...
## News
- 05-04-2020: Latest update with 20016 SARS-CoV-2 genomes. 
- 04-20-2020: Latest update with 12940 SARS-CoV-2 genomes. 
